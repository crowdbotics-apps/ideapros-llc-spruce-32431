...
## Project Structure
    ...
    ├── ideapros_llc_spruce_32431  # Django project configurations
...
1. Clone this repo and `cd ideapros_llc_spruce_32431`
...
2. Clone this repo and `cd ideapros_llc_spruce_32431`
